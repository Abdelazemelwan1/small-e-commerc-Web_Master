    ...
    return (
        <>
          <div className="bg-white dark:bg-gray-900 relative rounded-2xl">
            <div className="rounded-2xl flex flex-col items-center justify-between pt-0 md:pr-10 pb-0 md:pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl xl:px-5 lg:flex-row">
              <div className="w-[90%] md:w-full flex flex-col items-center dark:bg-gray-900   pt-5 md:pr-10 pb-15 md:pl-10 lg:pt-15 lg:flex-row">
                <div data-aos="fade-right" className="dark:bg-gray-900 w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-6/12">
                  <div className="dark:bg-gray-900 flex flex-col items-center justify-center w-full h-full relative lg:pr-10">
                    <img src="https://res.cloudinary.com/macxenon/image/upload/v1631570592/Run_-_Health_qcghbu.png" className="btn- z-50" />
                  </div>
                </div>



                <form data-aos="fade-left" onSubmit={loginrFormik.handleSubmit} className="dark:bg-gray-900 w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-6/12">
                  <div className="dark:bg-gray-800 flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
                    ...
                    <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                      ...
                      <div className="relative">
                          ...
                          {loginrFormik.errors.email && loginrFormik.touched.email ? <h2 className='dark:text-red-500 text-red-700 px-2 flex items-center gap-1'><span>*</span>{loginrFormik.errors.email}</h2> : null }
                      </div>
                      <div className="relative">
                          ...
                          {loginrFormik.errors.password && loginrFormik.touched.password ? <h2 className='dark:text-red-500 text-red-700 px-2 flex items-center gap-1 '><span>*</span>{loginrFormik.errors.password}</h2> : null }
                      </div>
                      ...
                      <div className="relative">
                          ...
                          <p className='dark:text-white text-center text-sm md:text-[16px] capitalize mt-3'>Create a new account : <Link className="text-[#6366F1] hover:text-[#0d10c5] capitalize dark:hover:text-white" to="/register"> register</Link></p>
