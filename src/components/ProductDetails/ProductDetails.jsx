...
export default function ProductDetails() {
    ...
    return (
        <>
            ...
            <div>
            <div className=" min-w -screen min-h-screen bg-[#6366F1] flex items-center p-5 lg:p-10 overflow-hidden relative">
                <Link to={"/"} className='absolute top-12 left-12 w-14 h-14 rounded-full border-2 border-[#2023d5]  z-20 flex items-center justify-center text-3xl'>🔙</Link>
                <div className="w-full max-w-6xl rounded bg-white shadow-xl p-10  mx-auto text-gray-800 relative md:text-left">
                    <div className="md:flex items-center -mx-10">
                        ...
                        <div className="mb-5">
                            <h1 className="font-bold uppercase text-2xl mb-5">{data?.data?.title}</h1>
                            <p className="text-sm">{data?.data?.description}<a  className="cursor-pointer opacity-50 text-gray-900 hover:opacity-100 inline-block text-xs leading-none border-b border-gray-900">MORE <i className="mdi mdi-arrow-right" /></a></p>
                        </div>
                        <div className='flex items-center justify-between mb-2'>
                            <h3 className='font-bold text-xl capitalize text-[#2023d5]'>{data?.data.category}</h3>
                        ...
                        <div>
                            ...
                            <span className="font-bold text-xl md:text-3xl leading-none align-baseline">{data?.data?.price}</span>
                            <span className="text-2xl leading-none align-baseline">EGP</span>
                            </div>
                            <div className='flex items-center justify-between mt-4'>
                                ...
                                <button onClick={() => { addToCart(data?.data)}}  className= "  bg-[#6366F1] opacity-75 duration-500 hover:opacity-100 text-white hover:text-white rounded-full px-5 md:px-10 py-2 font-semibold cursor-pointer flex items-center justify-center gap-3"><FaOpencart  className='text-2xl'/> BUY NOW</button>
                                </div>
                            </div>
                        </div>
                        </div>
  ...
  <h2 className='mt-10  text-center m-auto font-bold w-fit  py-4 text-xl border-4 border-transparent border-b-[#6063EA]  px-2'> products {category}</h2>
        ...
        {forItem.data?.map((prodct)=>
            <SwiperSlide>
                ...
                <div  key={prodct.id}>
                    ...
                    <div className="group relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                        <div className=" relative mx-4 mt-4 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40">
                            <header className='relative group'>
                                ...
                                <div   className='icon text-3xl p-1.5 w-[45px] h-[45px] flex items-center justify-center  rounded-full text-white opacity-0 translate-x-20 group-hover:translate-x-0 group-hover:opacity-100 bg-[#6366F1] hover:bg-[#2a2dd7] duration-300 cursor-pointer'>
                                    <CiHeart />
                                </div>
                                <div onClick={() => {addToCart(prodct)}}  className='icon text-3xl p-1.5 w-[45px] h-[45px] flex items-center justify-center  rounded-full text-white opacity-0 translate-x-20 group-hover:translate-x-0 group-hover:opacity-100 bg-[#6366F1] hover:bg-[#2a2dd7] duration-700 cursor-pointer'>
                                    <FaOpencart />
                                </div>
                                <div className='icon text-3xl p-1.5 w-[45px] h-[45px] flex items-center justify-center  rounded-full text-white opacity-0 translate-x-20 group-hover:translate-x-0 group-hover:opacity-100 bg-[#6366F1] hover:bg-[#2a2dd7] duration-1000 cursor-pointer'>
                        ...
                        <div className="p-6">
                            <h5 className=" font-sans text-xl font-medium leading-snug tracking-normal text-blue-gray-900 antialiased line-clamp-1">
                            {prodct.title}
                            </h5>
                            <p className="line-clamp-3 font-sans text-base font-light leading-relaxed text-gray-700 antialiased">
                                {prodct.description}
                            </p>
                            <div className="mb-3 flex items-center justify-between">
                                <h5 className="text-[#6366F1] capitalize font-sans text-xl font-medium leading-snug tracking-normal text-blue-gray-900 antialiased line-clamp-1">
                                {prodct.category}
                                </h5>
                            ...
                            <div className="mb-3 flex items-center justify-between">
                                ...
                                <h5 className="text-[#6366F1] capitalize font-sans text-md md:text-sm font-medium leading-snug tracking-normal text-blue-gray-900 antialiased">
